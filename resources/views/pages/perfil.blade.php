    ...
    <section class="flex flex-col items-center justify-between px-4 md:min-h-[85vh] md:max-w-xs mx-auto">
        <div class="flex flex-col w-full items-center">
            <div class="mb-2 md:mb-6 h-40 w-40">
                <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=160" alt="" class="rounded-full">
            </div>
